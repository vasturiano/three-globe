...
| <b>polygonCapColor</b>([<i>str</i>, <i>THREE.Mesh*Material</i> or <i>fn</i>]) | Polygon object accessor function or attribute for the color of the top surface. Can be a `string` or a ThreeJs `MeshMaterial`. | `() => '#ffffaa'` |
| <b>polygonSideColor</b>([<i>str</i>, <i>THREE.Mesh*Material</i> or <i>fn</i>]) | Polygon object accessor function or attribute for the color of the cone sides. Can be a `string` or a ThreeJs `MeshMaterial`. | `() => '#ffffaa'` |
| <b>polygonStrokeColor</b>([<i>str</i>, <i>THREE.Line*Material</i> or <i>fn</i>]) | Polygon object accessor function or attribute for the color to stroke the polygon perimeter. Can be a `string` or a ThreeJs `LineMaterial`. A falsy value will disable the stroking. | - |
